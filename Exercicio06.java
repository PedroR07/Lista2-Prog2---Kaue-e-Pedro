...
public class Exercicio6 {
    public static void main(String[] args) {
        ...
        int q = 0, n;
        while(q == 0){
            n = Integer.parseInt(JOptionPane.showInputDialog("Selecione a Operacão: \n1- Adicionar ou editar dados. \n2- Consultar dados."));
            switch (n) {
                case 1:
    ...
    public static void addDados(int[] A, int[] B, int[] C){
        int q = 0, ID, selector;
        while(q == 0){
        ID = Integer.parseInt(JOptionPane.showInputDialog(null, "Insira o ID da praia (de 0 à 15): "));
        selector = Integer.parseInt(JOptionPane.showInputDialog(null, "Selecione a operação: \n1- Alterar quantidade de veranistas. \n2- Alterar distância. \n3- Alterar estado da pavimentação. \n4- Voltar ao menu principal."));
        switch (selector){
            case 1:
            ...
            case 3:
                B[ID] = Integer.parseInt(JOptionPane.showInputDialog(null, "Insira o estado da pavimentação: "));
                break;
            case 4:
                q = 1;
                break;
    ...
    public static String maiorDist(int B[]){
        ...
        n = ("A praia mais distante do centro é a praia " + iD + ", com " + maiorD + " metros de distância.");
        return n;
    }
    public static String menorDist(int B[]){
        ...
        n = ("A praia mais próxima do centro é a praia " + iD + ", com " + menorD + " metros de distância.");
        return n;
    }
    public static String praiaMenosFreq(int A[]){
        ...
        n = ("A praia menos veranistas é a " + iD + ", com " + menorD + " veranistas.");
        return n;
    }
